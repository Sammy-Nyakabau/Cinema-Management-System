Public Class Cinema1
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Dim stConString As String = "Provider = Microsoft.ACE.OLEDB.12.0; Data Source = " & Application.StartupPath & "\Cinema 1.accdb"
    ...
    Private Sub Cinema1_Load(sender As Object, e As EventArgs) Handles Me.Load
        Dim c As Control
