Public Class Cinema3
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Dim stConString As String = "Provider = Microsoft.ACE.OLEDB.12.0; Data Source = " & Application.StartupPath & "\Cinema 3.accdb"
    ...
    Private Sub Cinema3_Load(sender As Object, e As EventArgs) Handles Me.Load
        Dim c As Control
